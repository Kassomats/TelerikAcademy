...
namespace Dealership.Engine
{
    public sealed class DealershipEngine : IEngine
    {
        ...
        private string AddVehicle(VehicleType type, string make, string model, decimal price, string additionalParam)
        {
            ...
            {
                vehicle = (Vehicle)this.factory.CreateCar(make, model, price, int.Parse(additionalParam));
            }
            else if (type == VehicleType.Motorcycle)
            {
                vehicle = (Vehicle)this.factory.CreateMotorcycle(make, model, price, additionalParam);
            }
            else if (type == VehicleType.Truck)
            {
                vehicle = (Vehicle)this.factory.CreateTruck(make, model, price, int.Parse(additionalParam));
            }
